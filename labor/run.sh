...
python small_graph.py --dataset flickr --layers 5 --epochs 50 --fanout 5 --hid 256 --lr 0.005 --wd 0 --batch_size 2048 --dropout 0.1 
...
# python small_graph.py --dataset flickr --layers 5 --epochs 50 --fanout 5 --hid 256 --lr 0.01 --wd 0 --batch_size 2048 --dropout 0.1 --mem_bench
